...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        headerSliverBuilder: (context, innerBoxIsScrolled) => [
          SliverAppBar(
            title: const Text('CineGlobal', style: TextStyle(fontWeight: FontWeight.w800, color: Colors.white)),
            ...
            actions: [
              IconButton(icon: const Icon(Icons.search, color: Colors.white), onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SearchPage()))),
              IconButton(icon: const Icon(Icons.notifications_outlined, color: Colors.white), onPressed: _showNotificationPanel),
              IconButton(icon: const Icon(Icons.map_rounded, color: Colors.white), onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (c) => const LbsPage()))),
            ],
            bottom: TabBar(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              ...
              const Positioned(
                bottom: 40, left: 20,
                child: Text("AVENGERS: DOOMSDAY", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w900)),
              ),
              Positioned(
                bottom: 10, left: 20,
                child: Container(
                  ...
                  child: const Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    SizedBox(width: 4),
                    Text("Trailer", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
                  ]),
                ),
              ),
            ],
  ...
  Widget _buildTrendingFilterChip(String label, String value) {
    ...
    return ChoiceChip(
      ...
      labelStyle: TextStyle(color: isSelected ? const Color(0xFF00113A) : Colors.grey.shade600, fontWeight: FontWeight.bold),
    );
  }
                  ...
                  Row(
                    children: [
                      ...
                      Text(rating.toStringAsFixed(1),
                          style: TextStyle(color: Colors.amber.shade700, fontSize: 12, fontWeight: FontWeight.w600)),
                    ],
                  ),
                ],
              ),
